//
//  SHWidgetBackgroundPicker.swift
//  SwiftHelper
//
...
extension SHWidgetBackground {
    static let item0: SHWidgetBackground = .init(.white)
    static let item1: SHWidgetBackground = .init(.black)
    static let item2: SHWidgetBackground = .init([Color(#colorLiteral(red: 0.8498876691, green: 0.7586856484, blue: 0.9849614501, alpha: 1)), Color(#colorLiteral(red: 0.6282964945, green: 0.7861559987, blue: 0.9820603728, alpha: 1))])
    static let item3: SHWidgetBackground = .init([Color(#colorLiteral(red: 0.9137254902, green: 0.5607843137, blue: 0.6196078431, alpha: 1)), Color(#colorLiteral(red: 0.937254902, green: 0.6156862745, blue: 0.5647058824, alpha: 1))])
    static let item4: SHWidgetBackground = .init([Color(#colorLiteral(red: 0.3215686275, green: 0.7058823529, blue: 0.6862745098, alpha: 1)), Color(#colorLiteral(red: 0.2784313725, green: 0.5294117647, blue: 0.5647058824, alpha: 1))])
    static let item5: SHWidgetBackground = .init([Color(#colorLiteral(red: 0.5098039216, green: 1, blue: 0.9647058824, alpha: 1)), Color(#colorLiteral(red: 1, green: 0.631372549, blue: 0.7803921569, alpha: 1))])
}

extension Array where Element == SHWidgetBackground {
    static let editItems: [SHWidgetBackground] = [.item0, .item1, .item2, .item3, .item4, .item5]
}
...
struct SHWidgetBackgroundPicker: View {
    ...
    @Binding var selection: SHWidgetBackground
    let data: [SHWidgetBackground]
            ...
            ForEach(items) { item in
                ...
                .onTapGesture {
                    if let lightImageURL = Store.shared.appState.widget.transparentCondiguration.lightWidgetPostionImageURLDict[item] {
                        ...
                        selection = SHWidgetBackground(transparent: (lightImageURL: lightImageURL, darkImageURL: darkImageURL ?? lightImageURL))
                    }
                }
            }
        }
...
#if DEBUG
struct SHWidgetBackgroundPicker_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SHWidgetBackgroundPicker(selection: .constant(.item0), data: .editItems, family: .systemSmall)
        }
