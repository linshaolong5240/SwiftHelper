//
//  SHRefreshableScrollView.swift
//  SwiftHelper
//
//  Created by sauron on 2022/5/6.
...
#if canImport(UIKit)
struct SHRefreshableScrollView<Content: View>: View {
...
struct SHRefreshableScrollViewDemo: View {
    @State private var refresh: Bool = false
    
    var body: some View {
        SHRefreshableScrollView(refreshing: $refresh) {
            VStack {
                ForEach(Array(1...100), id: \.self) { item in
                    Text("\(item)")
                }
            }
        }
...
#if DEBUG
struct SHRefreshableScrollView_Previews: PreviewProvider {
